...
public final class PropertiesSettingsService implements SettingsService {

  @Override
  public final void registerSettingsContainer(final SettingsContainer settingsContainer) {
    (new PropertiesSettingsContainer(settingsContainer)).load();
  }
}
